...
library BytesLib {
    ...
    function toUint(bytes memory _bytes) internal  pure returns (uint256) {
    ...
    function toUint16(bytes memory _bytes) internal  pure returns (uint8) {
    ...
    function toString(bytes memory byteCode) internal pure returns(string memory stringData) {
